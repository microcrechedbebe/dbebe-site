    ...
    <footer className="bg-ocean-800 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <span className="block text-[9px] text-ocean-300 tracking-widest uppercase">Micro-crèche • Besançon</span>
              </div>
            </div>
          ...
          {/* Contact */}
          <div>
            <h3 className="font-baloo font-bold text-base mb-4">Contact</h3>
            <div className="space-y-2.5">
              ...
              <a
                ...
                className="flex items-start gap-2 text-ocean-300 hover:text-white transition-colors text-sm focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-white rounded"
              >
          ...
          {/* Navigation */}
          <div>
            <h3 className="font-baloo font-bold text-base mb-4">Navigation</h3>
        ...
        <div className="mt-8 pt-6 border-t border-ocean-700 flex flex-col sm:flex-row items-center justify-between gap-3">
