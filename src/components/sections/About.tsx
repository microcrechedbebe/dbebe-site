      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <AnimatedSection>
          <div className="text-center mb-12 sm:mb-16">
            <span className="inline-block px-4 py-1.5 bg-ocean-100 text-ocean-600 rounded-full text-xs sm:text-sm font-bold mb-3 sm:mb-4">
              ✨ Notre monde
            </span>
          ...
          {PEDAGOGICAL_AXES.map((axe, i) => {
            ...
            return (
              <AnimatedSection key={i}>
                ...
                >
                  <div className={`w-10 h-10 sm:w-12 sm:h-12 rounded-xl ${style.icon} flex items-center justify-center mb-3 sm:mb-4`}>
                    <Icon size={20} className="text-white" />
                  </div>
                  <h3 className={`font-baloo font-bold text-base sm:text-lg ${style.text} mb-1 sm:mb-2`}>{axe.title}</h3>
